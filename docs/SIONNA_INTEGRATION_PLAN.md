...
- No recorded end-to-end run with real Sionna yet; defaults effectively stay in mock unless Sionna/TF are available.
- Antenna/ray settings and performance for sub-6/mmWave are not yet tuned or documented.
