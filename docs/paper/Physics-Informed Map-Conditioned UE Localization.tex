...
% Feature annotations
\node[font=\tiny, text=gray, align=left, anchor=west] at (5.8, 4.3) {Radio map: PathGain, SNR,\\SINR, Throughput, BLER};
...
\caption{Input map stack used by the map encoder. The top row shows the five radio-map channels (e.g., path gain, SNR/SINR, throughput, BLER), and the bottom row shows the semantic channels (height/footprint/roads/terrain).}
