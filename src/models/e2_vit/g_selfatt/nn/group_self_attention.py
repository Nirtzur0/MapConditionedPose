...
from ..functional import encoding as encoding_functions
from .. import nn as g_selfatt_nn
from ..groups import Group
from .activations import Swish
from ..utils.utils import normalize_tensor_one_minone
...
class GroupSelfAttention(nn.Module):
    def __init__(
        ...
        self.row_embedding = torch.nn.Sequential(
            ...
            g_selfatt_nn.LayerNorm(num_channels=16),
            Swish(),
    ...
    def initialize_indices(
        ...
        for i, h in enumerate(self.group.elements):
            ...
            row_indices_windows = patches[..., 1]
            col_indices_windows = patches[..., 0]
